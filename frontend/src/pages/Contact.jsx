    ...
    <div className="bg-gray-50">
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {contactInfo.map((info, index) => (
            <div key={index} className="text-center p-6 bg-soft-blue rounded-xl card-hover">
              ...
              <button className="text-sky-blue hover:text-deep-blue font-medium transition-colors duration-300">
                {info.action} →
              </button>
            </div>
          ))}
      ...
      <div className="bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <h2 className="text-2xl font-bold text-deep-blue mb-6 text-center">
            Visit Our Store
          </h2>
          <div className="rounded-xl overflow-hidden shadow-xl">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.9663095919354!2d-74.00425878459418!3d40.74844097932681!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c2593a6b5b7f9b%3A0x1234567890abcdef!2sEmpire%20State%20Building!5e0!3m2!1sen!2sus!4v1234567890"
              width="100%"
              height="400"
              style={{ border: 0 }}
              allowFullScreen=""
              loading="lazy"
              title="Nile Fashion Store Location"
            />
          </div>
        </div>
      </div>
